...
Build a strong communication foundation by establishing team norms, preferred collaboration tools, and conflict resolution strategies for effective teamwork.
...
Start the meeting by introducing each other and sharing your general academic and professional background. Discuss what motivated you to start your current program, your goals, and how you see your career upon graduation.

| Name | Major | Years in Program | Experience with related courses |
|------|-------|------------------|--------------------------------|
| 1. |  |  |  |
| 2. |  |  |  |
| 3. |  |  |  |
...
The start of a new semester is a great time to think about your goals.

| Name | Your goal for this semester (can be outside of class) |
|------|------------------------------------------------------|
| 1. |  |
| 2. |  |
| 3. |  |
...
### [5 minutes] Choose Your Preferred Chapter for Team Presentation

One chapter will be assigned to your team for the team presentation. Your role is to facilitate discussion using the assigned case study, NOT to simply summarize and present the chapter content.
...
As a team, rank the chapters with Team Presentation in order of preference:

| Chapter | Topic | Your Rank (1-8) |
|---------|-------|-----------------|
| Ch 2 | HR Strategy and Planning |  |
| Ch 3 | Equal Employment Opportunity |  |
| Ch 4 | Workforce, Jobs, and Job Analysis |  |
| Ch 6 | Recruiting High-Quality Talent |  |
| Ch 7 | Selecting Human Resources |  |
| Ch 8 | Training Human Resources |  |
| Ch 9 | Talent, Careers, and Development |  |
| Ch 11 | Total Rewards and Compensation |  |

> **Note:** Your team's presentation date will be available in the syllabus by the next class.

---

### [10 minutes] Team Presentation Expectations

As a presenter, your primary role is to be a **discussion facilitator**, not to lecture or explain concepts. Think of yourselves as case experts who guide the class through meaningful dialogue.
...
| Name | What difficulties do you expect to face? | How will you overcome these difficulties? |
|------|------------------------------------------|------------------------------------------|
| 1. |  |  |
| 2. |  |  |
| 3. |  |  |
...
### [5 minutes] Guidelines for Teamwork

You will work with your team members to complete different activities throughout the semester. Teamwork can only be successful if everyone brings their best to the table. As a team, create the rules you all agree to follow.
